                                ...
                                <td height="35">
                                    <table width="100%" border="0" align="center">
                                        ...
                                        <tr>
                                            ...
                                            <td height="35"><input type="text" id="boxx" name="calorie"
                                                    value='<?php echo $cal ?>'></td>
                                        </tr>
                                        <tr>
                                            <td height="35">HEIGHT:</td>
                                            <td height="35"><input type="text" id="boxx" name="height"
                                                    value='<?php echo $hei ?>' placeholder="Enter Height in foot"></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td height="35"><input type="text" id="boxx" name="weight"
                                                    value='<?php echo $wei ?>' placeholder="Enter Weight in kg"></td>
                                        </tr>
                                        <tr>
                                            <td height="35">FAT:</td>
                                            <td height="35"><input type="text" id="boxx" name="fat"
                                                    value='<?php echo $fa ?>'></td>
                                        </tr>
                                        <tr>
                                            <td height="35">REMARKS:</td>
                                            <td height="35"><textarea id="remarks" rows="5" name="remarks"
                                                    placeholder="Remarks not more than 200 character"
                                                    style="margin: 0px; width: 220px; height: 72px; resize:none;"><?php echo $remar ?></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                        <tr>
