                            ...
                            <table width="100%" border="0" align="center">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td height="35"><input type="text" name="name" id="boxxe" readonly="" required=""
                                                value='<?php echo $memid ?>'></td>
                                    </tr>
                                    <tr>
                                        <td height="35">NAME:</td>
                                        <td height="35"><input type="text" id="boxxe" readonly=""
                                    ...
                                    <tr>
                                        ...
                                        <td height="35"><input type="text" id="boxxe" readonly="" maxlength="10"
                                                value='<?php echo $mobile ?>'></td>
                                    </tr>
                                    <tr>
                                        <td height="35">EMAIL:</td>
                                        <td height="35"><input type="email" id="boxxe" readonly="" required=""
                                    ...
                                    <tr>
                                        ...
                                        <td height="35"><input type="text" id="boxxe" readonly=""
                                                value='<?php echo $jdate ?>'></td>
                                    </tr>
                                    <tr>
                                        <td height="35">STREET NAME:</td>
                                        <td height="35"><input type="text" id="boxxe" readonly=""
                                                value='<?php echo $streetname ?>'></td>
                                    </tr>
                                    <tr>
                                        <td height="35">STATE:</td>
                                        <td height="35"><input type="text" id="boxxe" readonly="" name="state"
                                    ...
                                    <tr>
                                        ...
                                        <td height="35"><input type="text" id="boxxe" readonly=""
                                                value='<?php echo $calorie ?>'></td>
                                    </tr>
                                    <tr>
                                        <td height="35">HEIGHT:</td>
                                        <td height="35"><input type="text" readonly="" id="boxxe"
                                                value='<?php echo $height ?>'></td>
                                    </tr>
                                    <tr>
                                        <td height="35">WEIGHT:</td>
                                        <td height="35"><input type="text" readonly="" value='<?php echo $weight ?>'
                                                id="boxxe"></td>
                                    </tr>
                                    <tr>
                                        <td height="35">FAT:</td>
                                    ...
                                    <tr>
                                        ...
                                        <td height="35"><input type="text" readonly="" id="boxxe"
                                                value='<?php echo $planname ?>'></td>
                                    </tr>
                                    <tr>
                                        <td height="35">PLAN AMOUNT:</td>
                                        <td height="35"><input type="text" readonly="" id="boxxe"
                                                value='<?php echo $pamount ?>'></td>
                                    </tr>
                                    <tr>
                                        <td height="35">PLAN VALIDITY:</td>
                                        <td height="35"><input type="text" readonly="" id="boxxe"
                                                value='<?php echo $pvalidity . ' Month' ?>'></td>
                                    </tr>
                                    <tr>
                                        <td height="35">PLAN DESCRIPTION:</td>
                                        <td height="35"><input type="text" readonly="" id="boxxe"
                                                value='<?php echo $pdescription ?>'></td>
                                    </tr>
                                    <tr>
                                        <td height="35">PAID DATE:</td>
                                        <td height="35"><input type="text" readonly="" id="boxxe"
                                                value='<?php echo $paiddate ?>'></td>
                                    </tr>
                                    <tr>
                                        <td height="35">EXPIRED DATE:</td>
                                        <td height="35"><input type="text" readonly="" id="boxxe"
                                                value='<?php echo $expire ?>'></td>
                                    </tr>
                                    <tr>
                                        <td height="35">REMARKS:</td>
                                        <td height="35"><textarea readonly
                                                style="resize:none; margin: 0px; width: 230px; height: 53px;"><?php echo $remarks ?></textarea>
                                        </td>
                                    </tr>
